...
import {Icon, Image, Overlay} from "react-native-elements/src/index";
...
import {
  ...
  getPillsType,
  getUIDfromFireBase, relImgToPill, removeRelationImgToPill,
...
class CreatePill extends Component {
  ...
  render() {
    ...
    return (
      <SafeAreaView
        style={[commonStyles.container, {paddingLeft: 0, paddingRight: 0, position: 'relative'}]}>
        <Overlay
